...
static irqreturn_t batt_hot_handler(int irq, void *_chip)
{
	...
	u8 reg = 0;
#if (defined CONFIG_MACH_XIAOMI_MIDO) || (defined CONFIG_MACH_XIAOMI_SAKURA) || (defined CONFIG_MACH_XIAOMI_DAISY) || (defined CONFIG_MACH_XIAOMI_VINCE)
	int rc;
